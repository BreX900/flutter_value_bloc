...
class FailureDataBlocNotifier<TBloc extends BlocBase<DataBlocState<dynamic, TFailure>>,
  ...
  Widget buildWithChild(BuildContext context, Widget? child) {
    return BlocListener<TBloc, DataBlocState<dynamic, TFailure>>(
      bloc: dataBloc,
...
mixin _ListenFailure<TFailure extends Object> {
  bool? get shouldListenWithData;

  void Function(BuildContext context, TFailure failure)? get listener;

  bool _listenWhen(DataBlocState<dynamic, TFailure> prev, DataBlocState<dynamic, TFailure> curr) {
    return prev.failure != curr.failure;
  }

  void _listenFailure(BuildContext context, DataBlocState<dynamic, TFailure> state) {
